...
public:
    ...
    int64_t server_rpc_latency_us() const { return _end_rpc_time_us - _begin_rpc_time_us; }
    void set_begin_rpc_time_us(int64_t begin_rpc_time_us) {
        _begin_rpc_time_us = begin_rpc_time_us;
    }
    void set_end_rpc_time_us(int64_t end_rpc_time_us) {
        _end_rpc_time_us = end_rpc_time_us;
    }
    ...
    void set_boss_guard(const BossGuard& boss_guard);
...
private:
    ...
    int64_t _begin_rpc_time_us;
    int64_t _end_rpc_time_us;
