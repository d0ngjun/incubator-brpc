...
struct JMapPair {
    ...
    bool operator==(const JMapPair<K, V> &r) const
    {
...
private:
    JArray<pair_type>       _v;
public:
    JArray<pair_type> &getArray()
    {
        return _v;
    }
    const JArray<pair_type> &getArray() const
    {
        return _v;
    }
    void clear()
...
////////////////////////////////////////////////////////////////////////////////////////////////
//获取类型名称
inline String getStructName(const taf::JceStructBase &t)
{
    return t.structName();
}
inline String getStructName(const taf::Bool & )
{
    return (signed char *)("bool");
}
inline String getStructName(const taf::Char & )
{
    return (signed char *)"char";
}
inline String getStructName(const taf::Short & )
{
    return (signed char *)"short";
}
inline String getStructName(const taf::Float & )
{
    return (signed char *)"float";
}
inline String getStructName(const taf::Double & )
{
    return (signed char *)"double";
}
inline String getStructName(const taf::Int32 & )
{
    return (signed char *)"int32";
}
inline String getStructName(const taf::Int64 & )
{
    return (signed char *)"int64";
}
inline String getStructName(const String & )
{
    return (signed char *)"string";
}

//add by edwardsu
inline String getStructName(const taf::UInt8 & )
{
    return (signed char *)"short";
}
inline String getStructName(const taf::UInt16 & )
{
    return (signed char *)"int32";
}
inline String getStructName(const taf::UInt32 & )
{
    return (signed char *)"int64";
}
