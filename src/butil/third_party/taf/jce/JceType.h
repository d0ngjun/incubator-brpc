...
//type2name
template<typename T> struct JceClass    {
    static std::string name()
    {
        return T::className();
    }
};
template<> struct JceClass<taf::Bool>   {
    static std::string name()
    {
        return "bool";
    }
};
template<> struct JceClass<taf::Char>   {
    static std::string name()
    {
        return "char";
    }
};
template<> struct JceClass<taf::Short>  {
    static std::string name()
    {
        return "short";
    }
};
template<> struct JceClass<taf::Float>  {
    static std::string name()
    {
        return "float";
    }
};
template<> struct JceClass<taf::Double> {
    static std::string name()
    {
        return "double";
    }
};
template<> struct JceClass<taf::Int32>  {
    static std::string name()
    {
        return "int32";
    }
};
template<> struct JceClass<taf::Int64>  {
    static std::string name()
    {
        return "int64";
    }
};
template<> struct JceClass<taf::UInt8>  {
    static std::string name()
    {
        return "short";
    }
};
template<> struct JceClass<taf::UInt16> {
    static std::string name()
    {
        return "int32";
    }
};
template<> struct JceClass<taf::UInt32> {
    static std::string name()
    {
        return "int64";
    }
};
template<> struct JceClass<std::string> {
    static std::string name()
    {
        return "string";
    }
};
template<typename T> struct JceClass<std::vector<T> > {
    static std::string name()
    {
        return std::string("list<") + JceClass<T>::name() + ">";
    }
};
template<typename T, typename U> struct JceClass<std::map<T, U> > {
    static std::string name()
    {
        return std::string("map<") + JceClass<T>::name() + "," + JceClass<U>::name() + ">";
    }
};
...
{
// is_convertible
template<int N> struct type_of_size {
    char elements[N];
};
...
inline void jce_copy_struct(char &a, const unsigned char &b)
{
    a = b;
}
inline void jce_copy_struct(unsigned char &a, const char &b)
{
    a = b;
}
template<typename T> inline void jce_copy_struct(T &a, const T &b)
{
    a = b;
}
