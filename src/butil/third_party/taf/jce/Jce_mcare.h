 ...
 * 获取类型名称
 */
inline String getStructName(const JceStructBase &t)
{
    return t.structName();
}
inline String getStructName(const Bool &)
{
    return (Char *)("bool");
}
inline String getStructName(const Char &)
{
    return (Char *)"char";
}
inline String getStructName(const Short &)
{
    return (Char *)"short";
}
inline String getStructName(const Float &)
{
    return (Char *)"float";
}
inline String getStructName(const Double &)
{
    return (Char *)"double";
}
inline String getStructName(const Int32 &)
{
    return (Char *)"int32";
}
inline String getStructName(const Int64 &)
{
    return (Char *)"int64";
}
inline String getStructName(const JString &)
{
    return (Char *)"string";
}
inline String getStructName(const UInt8 &)
{
    return (Char *)"int16";
}
inline String getStructName(const UInt16 &)
{
    return (Char *)"int32";
}
inline String getStructName(const UInt32 &)
{
    return (Char *)"int64";
}
