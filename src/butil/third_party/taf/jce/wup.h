...
public:
    ...
    void swap(UniPacket<TWriter, TReader, Alloc>& other)
    {
        std::swap(iVersion, other.iVersion);
        std::swap(cPacketType, other.cPacketType);
        std::swap(iMessageType, other.iMessageType);
        std::swap(iRequestId, other.iRequestId);
        sServantName.swap(other.sServantName);
        sFuncName.swap(other.sFuncName);
        std::swap(iTimeout, other.iTimeout);
        sBuffer.swap(other.sBuffer);
        context.swap(other.context);
        status.swap(other.status);
        std::swap(UniAttribute<TWriter, TReader, Alloc>::_iVer, other._iVer);
        UniAttribute<TWriter, TReader, Alloc>::_data.swap(other._data);
        UniAttribute<TWriter, TReader, Alloc>::_new_data.swap(other._new_data);
    }
    ...
    void encode(char *buff, size_t &len)
    {
        ...
        if (len < sizeof(taf::Int32) + os.getLength()) {
            throw runtime_error("encode error, buffer length too short");
        }
    ...
    void decode(const char *buff, size_t len)
    {
        if (len < sizeof(taf::Int32)) {
            throw runtime_error("packet length too short");
        }
...
public:
     ...
     * @param value
     */
    void setRequestId(taf::Int32 value)
    {
        iRequestId = value;
    }
    /**
...
public:
     ...
     * @param value
     */
    void setTafVersion(taf::Short value)
    {
        UniPacket<TWriter, TReader, Alloc>::setVersion(value);
    }
     ...
     * @param value
     */
    void setTafPacketType(taf::Char value)
    {
        this->cPacketType = value;
    }
     ...
     * @param value
     */
    void setTafMessageType(taf::Int32 value)
    {
     ...
     * @param value
     */
    void setTafTimeout(taf::Int32 value)
    {
        this->iTimeout = value;
    }
     ...
     * @param value
     */
    void setTafBuffer(const vector<taf::Char> &value)
    {
        this->sBuffer = value;
    }
     ...
     * @param value
     */
    void setTafContext(const map<std::string, std::string> &value)
    {
        this->context = value;
    }
     ...
     * @param value
     */
    void setTafStatus(const map<std::string, std::string> &value)
    {
        this->status = value;
    }
     ...
     * @return taf::Char
     */
    taf::Char getTafPacketType() const
    {
     ...
     * @return taf::Int32
     */
    taf::Int32 getTafMessageType() const
    {
     ...
     */
    const vector<taf::Char> &getTafBuffer() const
    {
        return this->sBuffer;
    }
     ...
     */
    const map<std::string, std::string> &getTafContext() const
    {
        return this->context;
    }
     ...
     * @return const map<std::string,std::string>&
     */
    const map<std::string, std::string> &getTafStatus() const
    {
        return this->status;
    }
    ...
    void swap(TafUniPacket<TWriter, TReader, Alloc>& other) {
        UniPacket<TWriter, TReader, Alloc>::swap(other);
    }
};
